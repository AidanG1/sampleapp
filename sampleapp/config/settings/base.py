...
ROOT_URLCONF = "sampleapp.config.urls"
# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "sampleapp.config.wsgi.application"
...
MIDDLEWARE = [
    ...
    "sampleapp.util.middleware.HTMXMessageMiddleware",
]
...
ADMINS = [("""Ben Beecher""", "ben-beecher@lightmatter.com")]
